...
(function(exports2) {
  ...
  if (typeof window === "undefined" || typeof MessageChannel !== "function") {
    ...
    f = function(a) {
      t2 !== null ? setTimeout(f, 0, a) : (t2 = a, setTimeout(w2, 0));
    };
    g = function(a, b) {
      u2 = setTimeout(a, b);
    };
  ...
  Nb(function() {
    ...
    a: {
      ...
      if (h2 !== void 0) {
        ...
        var w2 = (b & 4) !== 0, z2 = !w2 && a === "scroll", u2 = w2 ? h2 !== null ? h2 + "Capture" : null : h2;
        w2 = [];
...
async function mount(props) {
  ReactDOM.render(/* @__PURE__ */ React.createElement(App, null), props.container ? props.container.querySelector("#root") : document.getElementById("root"));
}
